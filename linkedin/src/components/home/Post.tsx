...
const Post = ({ information }: Props) => {
  ...
  return (
    <div className="bg-[#1B1F23] text-white px-4 py-3 rounded-lg">
      <div className="flex flex-row items-start justify-between">
        <div className="flex flex-row gap-x-2">
          <img src={Avatar} alt="" className="rounded-full w-14 h-14 my-auto" />
          <div>
            ...
            <div className="flex items-center">
              ...
              <Icon icon="bx:world" className="text-sm text-[#A4A5A7] ml-1" />
            </div>
          </div>
        </div>
        <div>
      ...
      <div className="flex flex-row gap-x-1 items-center justify-between mt-1">
        ...
        <button className="flex flex-row items-center gap-x-2 p-3 rounded-md hover:bg-[#44474B] transition-all duration-150 ease-in-out">
          <Icon icon="icon-park-outline:send" className="rounded-md text-2xl" />
          <p className="font-bold text-sm">Compartir</p>
        </button>
      </div>
    </div>
