...
const Header = () => {
  return (
    <div className="grid grid-cols-11 bg-[#242526] py-1 sticky top-0">
      ...
      <div className="col-span-5  flex gap-x-2 w-full">
        <button className="w-[18.8%]  flex items-center justify-center rounded-lg transition-colors duration-150 ease-in-out hover:bg-[#4E4F50]">
          <Icon icon="ph:house-fill" className="w-7 h-7 text-[#B8BBBF]" />
        </button>
        <button className="w-[18.8%]  flex items-center justify-center rounded-lg transition-colors duration-150 ease-in-out hover:bg-[#3A3B3C]">
